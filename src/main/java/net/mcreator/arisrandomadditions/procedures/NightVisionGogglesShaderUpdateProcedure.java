...
public class NightVisionGogglesShaderUpdateProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == ArisRandomAdditionsModItems.NIGHT_VISION_GOGGLES_HELMET.get()
		...
		} else if (!((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == ArisRandomAdditionsModItems.NIGHT_VISION_GOGGLES_HELMET.get())
				&& Minecraft.getInstance().gameRenderer.currentEffect() != null) {
